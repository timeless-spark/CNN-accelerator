...
for tensor in opt_model["model_state_dict"]:
    opt_model["model_state_dict"][tensor] = cs.myDoReFaWeightQuantization.quantize(opt_model["model_state_dict"][tensor], min_v, max_v, quant_method)
###load the dictionary
